...
#  --test-dir /home/yangwenhao/local/project/lstm_speaker_verification/data/libri/spect/dev_wcmvn \
  for loss in soft ; do
    ...
    python TrainAndTest/Spectrogram/train_lores10_kaldi.py \
      ...
      --lr 0.1 \
      --milestones 7,11 \
      --check-path Data/checkpoint/LoResNet10/${datasets}/spect/${loss}_128_0.25_8 \
      --resume Data/checkpoint/LoResNet10/${datasets}/spect/${loss}_128_0.25_8/checkpoint_1.pth \
      --alpha 8 \
      --channels 4,32,128 \
      --embedding-size 128 \
      --input-per-spks 256 \
