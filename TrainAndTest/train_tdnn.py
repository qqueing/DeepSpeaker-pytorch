...
parser.add_argument('--check-path', type=str, default='Data/checkpoint/tdnn/soft',
                    help='path to dataset')
parser.add_argument('--resume', default='Data/checkpoint/tdnn/soft/checkpoint_1.pth',
...
writer = SummaryWriter(logdir='Log/tdnn/soft', filename_suffix='vox1')
