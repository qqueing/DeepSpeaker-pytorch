...
parser.add_argument('--train-dir', type=str,
                    default='/home/yangwenhao/projects/kaldi/egs/voxceleb/v4/data/vox1_fb24/train_no_sli',
                    help='path to dataset')
parser.add_argument('--test-dir', type=str,
                    default='/home/yangwenhao/projects/kaldi/egs/voxceleb/v4/data/vox1_fb24/test_no_sli',
...
def test(test_loader, valid_loader, model, epoch):
    ...
    print(
        'For {}_distance: \n Embeddings a: \33[91mERR: {:.8f}. Threshold: {:.8f}.\33[0m \n Embeddings b: \33[91mERR: {:.8f}. Threshold: {:.8f}. \n Valid Accuracy is {}.\33[0m'.format( \
            'cos' if args.cos_sim else 'l2', 100. * eer_a, eer_threshold_a, 100. * eer_b, eer_threshold_b,
            valid_accuracy))
