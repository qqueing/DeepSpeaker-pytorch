...
parser.add_argument('--resume',
                    default='Data/checkpoint/resnet10_softmax/checkpoint_14.pth', type=str, metavar='PATH',
...
parser.add_argument('--test-input-per-file', type=int, default=3, metavar='IPFT',
...
writer = SummaryWriter(logdir='Log/softmax_res10', filename_suffix='vox1_fb64')
