...
parser.add_argument('--check-path', default='Data/checkpoint/SiResNet34/soft/dataset200',
                    help='folder to output model checkpoints')
parser.add_argument('--resume',
                    default='Data/checkpoint/SiResNet34/soft/dataset200/checkpoint_7.pth',
...
writer = SummaryWriter(args.check_path, filename_suffix='dataset200')
...
train_dir = SpeakerTrainDataset(dataset=train_dataset, dir=args.dataroot, feat_dim=64, loader=file_loader, transform=transform, samples_per_speaker=args.input_per_spks)
...
def main():
    ...
    scheduler = MultiStepLR(optimizer, milestones=[14, 22], gamma=0.1)
