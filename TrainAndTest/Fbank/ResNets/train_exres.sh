...
#  for loss in soft asoft ; do
  for loss in soft ; do
    ...
    python -W ignore TrainAndTest/Fbank/ResNets/train_exres_kaldi.py \
      --train-dir /home/yangwenhao/local/project/lstm_speaker_verification/data/Vox1_aug_fb64/dev_no_sil \
      --test-dir /home/yangwenhao/local/project/lstm_speaker_verification/data/Vox1_aug_fb64/test_no_sil \
      --nj 12 \
      --epochs 30 \
      --milestones 14,20,25 \
      --model ExResNet34 \
