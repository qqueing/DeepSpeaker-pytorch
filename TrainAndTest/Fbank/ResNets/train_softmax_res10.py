...
parser.add_argument('--ckp-dir', default='Data/checkpoint/10res_soft/sgd',
                    help='folder to output model checkpoints')

parser.add_argument('--resume',
                    default='Data/checkpoint/10res_soft/sgd/checkpoint_8.pth', type=str, metavar='PATH',
...
parser.add_argument('--min-softmax-epoch', type=int, default=15, metavar='MINEPOCH',
...
writer = SummaryWriter(logdir='Log/softmax_res10', filename_suffix='sgd_drop')
...
def train(train_loader, model, optimizer, epoch):
    ...
    for param_group in optimizer.param_groups:
        ...
        print('\33[1;34m Optimizer {} learning rate is {}.\33[0m \n'.format(args.optimizer, param_group['lr']))
