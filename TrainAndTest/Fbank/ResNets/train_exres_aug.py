...
@Software: PyCharm
@File: train_exres_aug.py
@Time: 2020/3/28 4:31 PM
@Overview:
"""
...
parser.add_argument('--test-batch-size', type=int, default=6, metavar='BST',
...
def main():
    ...
    scheduler = MultiStepLR(optimizer, milestones=[15, 24, 32], gamma=0.1)
