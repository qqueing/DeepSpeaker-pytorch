...
@Software: PyCharm
@File: fine_exres_cnc.py
@Time: 2020/3/31 3:48 PM
@Overview:
"""
...
parser.add_argument('--train-dir', type=str,
                    default='/home/yangwenhao/local/project/lstm_speaker_verification/data/cnceleb_fb64/dev_cmvn',
                    help='path to dataset')
parser.add_argument('--test-dir', type=str,
                    default='/home/yangwenhao/local/project/lstm_speaker_verification/data/cnceleb_fb64/test_cmvn',
...
parser.add_argument('--check-path', default='Data/checkpoint/ExResNet34/cnceleb/kaldi_cmvn_80',
