...
train_dir = SpeakerTrainDataset(dataset=train_dataset, dir=args.dataroot, feat_dim=64, loader=file_loader,
                                transform=transform, samples_per_speaker=args.input_per_spks)
