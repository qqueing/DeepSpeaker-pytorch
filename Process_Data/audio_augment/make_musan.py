...
def get_args():
    ...
    parser.add_argument("--use-vocals", action='store_true', default=True,
    ...
    parser.add_argument("--in-dir", type=str, dest="in_dir", default='/data/musan',
                        help="Input data directory")
    parser.add_argument("--out-dir", type=str, dest="out_dir",
                        default='/home/cca01/work2019/yangwenhao/mydataset/musan',
