...
class DeepSpeakerDataset(data.Dataset):
    ...
    def __init__(self, voxceleb, dir, n_triplets,loader, transform=None, *arg, **kw):
        """
        :param voxceleb: list with data like: {'filename': file[0], 'speaker_id': file[2], 'uri': 0, 'subset': file[1]}
        :param dir: datatoor dir
        :param n_triplets: num of triplets
        :param loader:
        :param transform:
        :param arg:
        :param kw:
        ...
        if len(voxceleb) == 0:
            raise(RuntimeError(('There is no data in voxceleb!')))
