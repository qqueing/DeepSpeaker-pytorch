...
@Software: PyCharm
@File: sires_extract_script.py
@Time: 2020/3/23 12:42 AM
@Overview:
"""
# !/usr/bin/env python
# encoding: utf-8
...
def train_extract(train_loader, model, epoch, set_name):
    ...
    for batch_idx, (data, label, uid) in pbar:
        ...
        # pdb.set_trace()
        classfier[0][label.long()].backward()
...
def main():
    ...
    for e in epochs:
        ...
        train_extract(train_loader, model, e, 'vox1_train')
        train_extract(valid_loader, model, e, 'vox1_valid')
